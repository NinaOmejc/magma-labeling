...
function testExampleRecordingRunsAtMasterRate(testCase)
    ...
    weak_sets = struct('shallowB',events_ShB,'deepB',events_DeB, ...
        'thorDomB',events_TDB,'irregB',events_IrB,'slowB',events_SlB, ...
        'rapidB',events_RaB,'asyncB',events_ReA,'desat',events_Des, ...
    ...
    reviewed_available = label_available & any(annotations.gold_review_mask,1);
    reviewed_assessable = assessable & annotations.gold_review_mask;
    reviewed_reasons = reasons;
    reviewed_reasons(~any(annotations.gold_review_mask,1)) = {'unreviewed'};
