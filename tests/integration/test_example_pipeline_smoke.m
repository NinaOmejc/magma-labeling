...
function testExampleRecordingRunsAtMasterRate(testCase)
    ...
    diagnostic = compute_label_diagnostic_signals( ...
        resp_features, diagnostics_desat, config, diagnostics_async, ...
        diagnostics_apnea, diagnostics_sigh, diagnostics_csr);
    ...
    verifyEqual(testCase, read_hdf5_text(hdf5_file, ...
        '/resp_features/detector_diagnostics/csr/primary_method'), {'eami'});
    verifyEqual(testCase, read_hdf5_text(hdf5_file, ...
        '/resp_features/detector_diagnostics/csr/eami/reference_doi'), ...
        {'10.5665/sleep.4494'});
    verifyEqual(testCase, read_hdf5_text(hdf5_file, ...
        '/resp_features/detector_diagnostics/csr/guyot/reference_doi'), ...
