...
% Label 4 - mean respiratory rate >= the configured threshold, sustained
% for the configured duration. Rate is evaluated independently per usable
% belt; amplitude and SpO2 do not modify rapid-breathing events.
    ...
    [events_lungs, rapid_lungs] = sustained_condition_to_events( ...
        rapid_lungs_endpoint, t_grid, config.fs, N, min_dur_sec, ...
        'rapid_breathing_lungs');
    [events_diaph, rapid_diaph] = sustained_condition_to_events( ...
        rapid_diaph_endpoint, t_grid, config.fs, N, min_dur_sec, ...
