...
function validate_export_inputs(filename, results, raw, preprocessed)
    ...
    required = {'config', 'phys_feat', 'resp_ref', 'label_names', ...
        ...
        'label_schema_version', 'annotation_schema_version', ...
    ...
    vector_fields = {'label_available', 'label_availability_reason', 'review_status'};
    ...
    mask_fields = {'label_assessable_mask', 'mask_weak', ...
        'mask_reviewed', 'gold_review_mask'};
